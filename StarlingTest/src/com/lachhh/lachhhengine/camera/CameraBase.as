package com.lachhh.lachhhengine.camera {
	...
	public class CameraBase extends Actor {
		...
		public function getMouseInWorld():Point {
			var mouseXFromCenter:Number = KeyManager.GetMousePos().x - (ResolutionManager.getGameWidth()*0.5);
			var mouseYFromCenter:Number = KeyManager.GetMousePos().y - (ResolutionManager.getGameHeight()*0.5);
